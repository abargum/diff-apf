...
class AllPass1stCell(Module):
    def __init__(self):
        super(AllPass1stCell, self).__init__()
    ...
    def forward(self, input, state):
        ...
        output = (self.a * input + state)
        state = input - self.a * output
        return output, state

class AllPass1stOrder(Module):
    def __init__(self):
        super(AllPass1stOrder, self).__init__()
        self.cell = AllPass1stCell()
